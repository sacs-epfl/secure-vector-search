\begin{tikzpicture}
  \begin{axis}[
    ...
    title={\texttt{sap-ivf} ($\beta{=}0$) @ nprobe=32: latency vs threads},
    legend style={
    ...
    \foreach \slug/\dlabel in \canonicalSeries {%
      \IfFileExists{\datadir/03-parallel-scaling-sap-ivf-beta-0-0000-nprobe-32-\slug.tsv}{%
        \edef\xtemp{%
          \noexpand\addplot+ table[x=threads, y=latency_ms]
            {\datadir/03-parallel-scaling-sap-ivf-beta-0-0000-nprobe-32-\slug.tsv};%
