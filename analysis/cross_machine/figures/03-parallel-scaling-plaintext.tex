\begin{tikzpicture}
  \begin{axis}[
    ...
    title={\texttt{plaintext} @ nprobe=32: latency vs threads},
    legend style={
    ...
    \foreach \slug/\dlabel in \canonicalSeries {%
      \IfFileExists{\datadir/03-parallel-scaling-plaintext-nprobe-32-\slug.tsv}{%
        \edef\xtemp{%
          \noexpand\addplot+ table[x=threads, y=latency_ms]
            {\datadir/03-parallel-scaling-plaintext-nprobe-32-\slug.tsv};%
